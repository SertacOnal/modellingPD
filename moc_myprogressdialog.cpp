...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyProgressDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 17, 13), // "handleTimeOut"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 6) // "cancel"

    },
    "MyProgressDialog\0handleTimeOut\0\0cancel"
};
...
void MyProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MyProgressDialog *_t = static_cast<MyProgressDialog *>(_o);
        switch (_id) {
...
void *MyProgressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyProgressDialog.stringdata))
